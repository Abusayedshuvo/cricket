...
const Subscribe = () => {
  return (
    <>
      <div className="container max-w-[1320px] rounded-3xl p-6 text-center bg-white/50 2xl:outline outline-white ">
        <div className=" bg-white rounded-3xl border border-primary/10 relative overflow-hidden">
          <div className="relative py-[88px] z-10">
            ...
            <div className="2xl:flex items-center justify-center gap-4">
              <input
